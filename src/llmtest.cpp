...
// cleos -u http://your-blockchain-node-url:port set contract llmtest ./ llmtest.wasm llmtest.abi
// eosio-cpp --abigen ./src/llmtest.cpp -o llmtest.wasm
// cleos -u http://your-blockchain-node-url:port system buyram eosio llmtest "1000.0000 SYS" -p eosio@active